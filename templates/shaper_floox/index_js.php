...
if (isset($menu) && $menu) {
    ...
    $menu_class = $menu->getParams()->get('pageclass_sfx');
}
...
if ($header_variation = $this->helix3->getParam('header_variation')) {
    $body_classes .= ' header-' . $header_variation;
}
    ...
    <head>
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
            <meta name="viewport" content="width=device-width, initial-scale=1">
                ...
                $this->helix3->addCSS('bootstrap.min.css, font-awesome.min.css, floox-icon.css') // CSS Files
                        ...
                        ->lessInit()->setLessVariables(array(
                            ...
                            'gradient_top_color' => $this->helix3->PresetParam('_gradient_top'),
                            'gradient_bottom_color' => $this->helix3->PresetParam('_gradient_bottom'),
